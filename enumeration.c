...
static int add_sensor (int dev_num, int catalog_index, int mode)
{
	...
	/* Initialize prop_matrix using hwdb_sensor if available
	 * or fallback to Android properties */
